...
Over 2400 .NFO files with abstracts and speakers listed.  Scripts grab talks and then rename them (to "DEF CON - S08E35 - [talk title]") so Jellyfin can easily injest them.  Also included are 45 of the most prolific speakers' photographs included (with more coming), so when you go into speaker details you get a pic of them.  A bit under 85GB of video content will be downloaded (and then served) with these containers.
